...
*   sorted by name.
*/
async function collectInventory(ctx, scope, onDrift) {
...
async function collectSkills(ctx, scope, onDrift) {
	const snapshot = await ctx.skills.snapshot(scope === void 0 ? {} : { scope });
