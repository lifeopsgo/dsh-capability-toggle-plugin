window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function parseConfirmCard(value) {
			...
			if (typeof id !== "string" || id === "" || typeof guardId !== "string" || guardId === "" || guardAction !== "deny" && guardAction !== "ask" || typeof reason !== "string" || typeof toolName !== "string" || typeof detail !== "string") return null;
			return {
				id,
				guardId,
				guardAction,
		...
		function parseConfirmPush(value) {
			...
			if ("resolved" in value) return value.resolved === true && typeof value.id === "string" && value.id !== "" ? {
				kind: "resolved",
				id: value.id
			} : null;
		...
		function subscribeConfirm(session, onPush) {
			if (session === "") return () => {};
		...
		async function respondConfirm(session, id, decision) {
			try {
		...
		*/
		...
		function tabCounts(rows) {
			const counts = Object.fromEntries(TAB_ORDER.map((id) => [id, {
				enabled: 0,
				total: 0
			}]));
			for (const row of rows) for (const id of TAB_ORDER) {
				if (!TAB_KINDS[id].includes(row.kind)) continue;
				const bucket = counts[id];
				bucket.total += 1;
				if (row.kind === "guard" ? row.disabled : !row.disabled) bucket.enabled += 1;
			}
			return counts;
		}
		function levelsVisible(scope) {
						...
						children: [
							expandable ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "dshct-row-text",
										children: displayName
									}),
									showUsage && row.callCount !== void 0 && row.callCount > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "dshct-usage",
										title: t("usage.calls.title", { count: row.callCount }),
										children: t("usage.calls", { count: row.callCount })
									}) : null
								]
							}) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							visibleLevels.map((level) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LevelSwitch, {
								level,
		...
		*/
		...
		function Panel(props) {
			...
			const [prefsOpen, setPrefsOpen] = (0, react.useState)(false);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				style: { "--dshct-lv-n": visibleLevels.length },
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							className: "dshct-header-actions",
							children: [offCount > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					prefsOpen ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "dshct-prefs",
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								className: "dshct-pref-row",
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									className: "dshct-pref-text",
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "dshct-pref-label",
										id: "dshct-pref-fraction",
										children: t("prefs.fraction")
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "dshct-pref-hint",
										children: t("prefs.fraction.hint")
									})]
									...
									onClick: () => props.onPrefsChange({
										...prefs,
										showFraction: !prefs.showFraction
									})
								})]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "dshct-pref-label",
										id: "dshct-pref-usage",
										children: t("prefs.usage")
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "dshct-pref-hint",
										children: t("prefs.usage.hint")
									})]
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									role: "switch",
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "dshct-pref-label",
										id: "dshct-pref-levels",
										children: t("prefs.levels")
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										className: "dshct-pref-hint",
										children: t("prefs.levels.hint")
									})]
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("select", {
									className: "dshct-pref-select",
									value: prefs.levels,
									"aria-labelledby": "dshct-pref-levels",
									onChange: (e) => props.onPrefsChange({
										...prefs,
										levels: e.target.value
									}),
									children: LEVEL_SCOPES.map((scope) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
										value: scope,
										children: t(`prefs.levels.${scope}`)
									}, scope))
								})]
							})
						]
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: TAB_ORDER.map((id) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
							...
							children: [t(`tab.${id}`), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								title: t("tab.count.title", {
									enabled: counts[id].enabled,
									total: counts[id].total
								}),
								children: prefs.showFraction ? `${counts[id].enabled}/${counts[id].total}` : counts[id].total
							})]
						}, id))
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							visibleLevels.map((level) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					searchOpen ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							visibleLevels.map((level) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BulkActions, {
								level,
								open: bulkMenu === level,
		...
		*/
		function ConfirmationCard(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "dshct-confirm-head",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "dshct-confirm-badge",
							"data-action": props.guardAction,
							children: props.guardAction === "deny" ? props.t("guard.action.deny") : props.t("guard.action.ask")
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "dshct-confirm-title",
							children: props.t("guard.confirm.title")
						})]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "dshct-confirm-body",
						children: props.t("guard.confirm.body", {
							guard: guardName,
							tool: props.toolName
						})
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "dshct-confirm-section",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: "dshct-confirm-label",
							children: props.t("guard.confirm.reason")
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: "dshct-confirm-reason",
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: "dshct-confirm-label",
							children: props.t("guard.confirm.detail")
					...
					props.busy ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "dshct-confirm-waiting",
						children: props.t("guard.confirm.waiting")
					}) : null,
					props.failed ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: "dshct-confirm-error",
						role: "alert",
						children: props.t("guard.confirm.retry")
					}) : null,
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "dshct-confirm-actions",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							...
							children: props.t("guard.confirm.deny")
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: "dshct-confirm-btn",
							"data-kind": "allow",
							...
							children: props.t("guard.confirm.allow")
						})]
					})
				]
			});
		...
		const dictionaries = {
			zh: {
				...
				"guard.readonly.desc": "开启后，本 agent 的文件写入/编辑（write、edit，以及 str_replace_editor 的 create/str_replace/insert 子命令）一律拦截并返回错误，str_replace_editor 的只读 view 仍可用；bash/pwsh 里的 tee、sed -i、Set-Content 等写入命令也一并拦截。只能读不能改，适合让 agent 只做分析、审查而不动代码。",
				"guard.protect-secrets.name": "保护密钥",
				"guard.protect-secrets.desc": "开启后，凡涉及 .env、私钥（*.pem、id_rsa）、credentials、.ssh/ 等密钥文件的读写或 bash/pwsh 命令一律拦截。防止密钥被读出或覆写。",
				"guard.dangerous-shell.name": "危险 shell 需确认",
				"guard.dangerous-shell.desc": "开启后，rm -rf、dd、mkfs、chmod 777、curl|sh、fork 炸弹（bash），以及 Remove-Item -Recurse -Force、Format-Volume、Stop-Computer（pwsh）等高危命令不直接执行，转为向你发起一次审批确认——你点允许才跑，否则拦截。",
				"guard.no-destructive-git.name": "破坏性 git 需确认",
				"guard.no-destructive-git.desc": "开启后，git push --force、reset --hard、clean -fd、branch -D 等会丢历史/丢改动的命令（bash 与 pwsh 通用）转为审批确认，你点允许才执行。",
				"guard.no-network.name": "外网出站需确认",
				"guard.no-network.desc": "开启后，联网动作（web_search、web_fetch，以及 bash 的 curl/wget/git push/npm publish、pwsh 的 Invoke-WebRequest/Invoke-RestMethod 等）转为审批确认，你点允许才执行。适合离线或敏感环境。",
				...
				"guard.confirm.title": "安全守卫请求确认",
				"guard.confirm.body": "守卫「{guard}」拦截了一次 {tool} 调用，需要你决定：",
				"guard.confirm.reason": "原因",
				"guard.confirm.detail": "调用内容",
				"guard.confirm.allow": "允许一次",
				"guard.confirm.deny": "拒绝",
				"guard.confirm.waiting": "等待确认中…（agent 已暂停在此调用）",
				"guard.confirm.retry": "未能确认响应结果，请再次选择「仅允许一次」或「拒绝」。",
				...
				"usage.calls": "调用 {count} 次",
				"usage.calls.title": "本会话模型已请求调用此能力 {count} 次（含被拦截或转确认而未执行的）",
				"tab.count.title": "已启用 {enabled} 项，共 {total} 项",
				"prefs.toggle": "显示设置",
				"prefs.fraction": "标签页显示「启用数 / 总数」",
				"prefs.fraction.hint": "安全标签下守卫只有已生效才计入启用数，未生效的守卫仍计入总数",
				"prefs.usage": "显示调用统计",
				"prefs.usage.hint": "在能力名称旁显示本会话被模型调用的次数",
				"prefs.levels": "显示的层级列",
				"prefs.levels.hint": "仅影响显示，被隐藏层级的设定仍照常生效",
				"prefs.levels.session": "会话级",
				"prefs.levels.session-project": "会话级 + 项目级",
				"prefs.levels.all": "会话级 + 项目级 + 全局",
			...
			en: {
				...
				"guard.readonly.desc": "When on, file writes/edits by this agent (write, edit, and the create/str_replace/insert subcommands of str_replace_editor) are blocked with an error — str_replace_editor's read-only view still works; write commands inside bash/pwsh (tee, sed -i, Set-Content) are blocked too. It can read but not change files. Good for analysis or review runs that must not touch code.",
				"guard.protect-secrets.name": "Protect secrets",
				"guard.protect-secrets.desc": "When on, any read/write or bash/pwsh command touching secret files (.env, private keys *.pem/id_rsa, credentials, .ssh/) is blocked, so secrets cannot be read out or overwritten.",
				"guard.dangerous-shell.name": "Confirm dangerous shell",
				"guard.dangerous-shell.desc": "When on, high-risk commands — rm -rf, dd, mkfs, chmod 777, curl|sh, fork bombs (bash), and Remove-Item -Recurse -Force, Format-Volume, Stop-Computer (pwsh) — are not run directly; they raise one approval prompt to you and run only if you allow, else blocked.",
				"guard.no-destructive-git.name": "Confirm destructive git",
				"guard.no-destructive-git.desc": "When on, history/work-losing git commands (push --force, reset --hard, clean -fd, branch -D — same on bash and pwsh) raise an approval prompt and run only if you allow.",
				"guard.no-network.name": "Confirm outbound network",
				"guard.no-network.desc": "When on, network actions — web_search, web_fetch, curl/wget/git push/npm publish (bash), Invoke-WebRequest/Invoke-RestMethod (pwsh) — raise an approval prompt and run only if you allow. Good for offline or sensitive environments.",
				...
				"guard.confirm.title": "Safety guard needs your decision",
				"guard.confirm.body": "The \"{guard}\" guard blocked a {tool} call and needs you to decide:",
				"guard.confirm.reason": "Reason",
				"guard.confirm.detail": "Call detail",
				"guard.confirm.allow": "Allow once",
				"guard.confirm.deny": "Deny",
				"guard.confirm.waiting": "Waiting for your decision… (the agent is paused on this call)",
				"guard.confirm.retry": "Response could not be confirmed. Try Allow once or Deny again.",
				...
				"usage.calls": "called {count}",
				"usage.calls.title": "Requested {count} time(s) by the model this session, including calls blocked or sent to confirm",
				"tab.count.title": "{enabled} of {total} enabled",
				"prefs.toggle": "Display settings",
				"prefs.fraction": "Show “enabled / total” on tabs",
				"prefs.fraction.hint": "On the Security tab a guard counts as enabled only while it is active; inactive guards still count toward the total",
				"prefs.usage": "Show call stats",
				"prefs.usage.hint": "Show how many times the model called each capability this session, beside its name",
				"prefs.levels": "Level columns to show",
				"prefs.levels.hint": "Affects display only — hidden levels keep applying as before",
				"prefs.levels.session": "Session",
				"prefs.levels.session-project": "Session + Project",
				"prefs.levels.all": "Session + Project + Global",
		...
		const PREFS_KEY = "dsh-capability-toggle-plugin:panel-prefs";
		const DEFAULT_PREFS = {
			showFraction: true,
			showUsage: true,
			levels: "all"
		};
		function isLevelScope(value) {
			return LEVEL_SCOPES.includes(value);
		}
		function defaultStorage() {
			if (typeof localStorage === "undefined") return void 0;
			return localStorage;
		}
		function readPrefs(storage = defaultStorage()) {
			...
			return {
				showFraction: candidate.showFraction,
				showUsage: candidate.showUsage,
				levels: candidate.levels
			};
		}
		function writePrefs(prefs, storage = defaultStorage()) {
		...
		function runningOf(props) {
			const legacy = props.session?.running;
			if (typeof legacy === "boolean") return legacy;
			if (props.useSession === void 0) return false;
...
`;
		...
		*/
		...
		function CapabilityToggleControl(props) {
			...
			const [prefs, setPrefs] = (0, react.useState)(readPrefs);
			...
			const onPrefsChange = (0, react.useCallback)((next) => {
				setPrefs(next);
				writePrefs(next);
			}, []);
			const scopeRef = (0, react.useRef)(null);
			const [, rerender] = (0, react.useState)(0);
			const updateScope = (0, react.useCallback)((next) => {
				scopeRef.current = next;
				rerender((n) => n + 1);
			}, []);
			const apply = (0, react.useCallback)((cards) => {
			...
			const applyRef = (0, react.useRef)(apply);
			...
			(0, react.useEffect)(() => {
				...
				rerender((n) => n + 1);
				const stop = subscribeConfirm(sessionId, (push) => {
					const current = scopeRef.current;
					if (!current || !current.active) return;
					if (push.kind === "snapshot") {
						const next = /* @__PURE__ */ new Map();
						for (const card of push.cards) next.set(card.id, {
							card,
							status: "idle"
						});
			...
			const onAnswer = (0, react.useCallback)((id, decision) => {
				const scope = scopeRef.current;
				if (scope === null) return;
				const entry = scope.cards.get(id);
				if (entry === void 0 || entry.status === "busy") return;
				...
				apply(next);
				respondConfirm(scope.sessionId, id, decision).then((outcome) => {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					confirmList.map((entry) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ConfirmationCard, {
